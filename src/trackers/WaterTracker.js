...
export default function WaterTracker() {
  ...
  const fillHeight = (hydration / 100) * SVG_HEIGHT;
          ...
          <div className="water-tracker-container">
            <div className="svg-wrapper">
              ...
              >
                ...
                {/* SVG body outline on top */}
                <use href="#body" fill="none" stroke="#000" strokeWidth="2" />
              </svg>

              <div className="hydration-label">{hydration}%</div>
            </div>
          </div>
        </div>
        <div className="water-container">
         ...
         <div style={{ flex: 1 }}>
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={intakeData} margin={{ top: 20, right: 20, left: 0, bottom: 10 }}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="date" />
              <YAxis domain={[0, 100]} />
              <Tooltip />
              <Line type="monotone" dataKey="intake" stroke="#3b82f6" strokeWidth={2} />
            </LineChart>
          </ResponsiveContainer>
        </div>
    </div>
