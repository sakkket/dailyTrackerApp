...
const ExpenditureReports = () => {
  ...
  return (
    <>
      {loading && (
        <div className={styles.loaderOverlayReport}>
          <CircularProgress
            size={70}
            thickness={4}
            className={styles.rainbowLoaderReport}
          />
          <div className={styles.loaderTextReport}>loading...</div>
        </div>
      )}
      <Box sx={{ py: 1 }}>
        ...
        {expenditureReports.length ? (
                  ...
                  <CardContent>
                    <Stack spacing={1}>
                      <Typography variant="h6" fontWeight={600}>
                        {report?.month
                          ? moment(report?.month).format("MMM YYYY")
                          : ""}
                      </Typography>
                      ...
                      <Typography variant="body2">
                        ...
                        {currencySymbol + report.totalSpend}
                      </Typography>
                    </Stack>
                  </CardContent>
          ...
          <Typography variant="body1" color="text.secondary" mb={4}>
            <i>
              No Reports Avaialable. Reports are generated at end of every month
            </i>
          </Typography>
        )}
      </Box>
