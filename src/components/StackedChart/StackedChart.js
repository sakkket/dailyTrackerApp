...
const DailySpendStackedChart = ({ data, view, title, keys }) => {
  ...
  new Set(data.flatMap((d) => Object.keys(d).filter((k) => (k !== "date" && k !== 'totalExpenditure') )))
);
...
export default DailySpendStackedChart;
